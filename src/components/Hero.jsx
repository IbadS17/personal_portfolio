...
const Hero = ({ isDarkMode }) => {
  ...
  const cols =
    typeof window !== "undefined"
      ? Math.ceil(window.innerWidth / cellSize) + 2
      : 42;
  const rows =
    typeof window !== "undefined"
      ? Math.ceil(window.innerHeight / cellSize) + 2
      : 22;

  const getCellOpacity = (col, row) => {
  ...
  return (
    ...
    >
      {/* Animated Grid Background with Hover Effect */}
